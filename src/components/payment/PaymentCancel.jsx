...
const PaymentCancel = () => {
  ...
  useEffect(() => {
    ...
    console.log('Payment Cancelled:', { code, id, status, orderCode });
    
    // Show cancel message for 3 seconds then redirect to package page
      ...
      <div className="max-w-md w-full bg-white rounded-lg shadow-lg p-8 text-center">
        <div className="mb-6">
          ...
          <p className="text-gray-600 mb-4">
            Giao dịch của bạn đã được hủy. Bạn có thể thử lại bất cứ lúc nào.
          </p>
